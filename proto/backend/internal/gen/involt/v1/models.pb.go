...
type Reading struct {
	...
	IsPaid           bool    `protobuf:"varint,26,opt,name=is_paid,json=isPaid,proto3" json:"is_paid,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
const file_involt_v1_models_proto_rawDesc = "" +
	...
	"\x12last_reading_value\x18\x0e \x01(\x01R\x10lastReadingValue\"\xf2\x06\n" +
	"\aReading\x12\x0e\n" +
	...
	"\rcustomer_name\x18\x19 \x01(\tR\fcustomerName\x12\x17\n" +
	"\ais_paid\x18\x1a \x01(\bR\x06isPaid\"[\n" +
	"\tAppConfig\x12(\n" +
