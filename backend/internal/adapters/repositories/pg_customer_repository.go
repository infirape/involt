...
func (r *PostgresCustomerRepository) SaveBatch(ctx context.Context, customers []domain.Customer) error {
	query := `INSERT INTO customers (id, code, name, community_id, sector_id, connection_type, tariff, meter_number, latitude, longitude, last_reading_value) 
	          VALUES (:id, :code, :name, :communityid, :sectorid, :connectiontype, :tariff, :meternumber, :latitude, :longitude, :lastreadingvalue) 
